...
In the past this function was implemented using incompatible, vendor-specific proprietary protocols. Typically, the coil is identified with a unique code which is associated with a specific data file on the scanner.
...
